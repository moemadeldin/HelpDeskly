...
<div class="p-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-200">
            ...
            <a href="#}" class="text-blue-600 hover:text-blue-500 font-medium transition duration-200">Explore Knowledge Base</a>
        </div>

        <!-- User Profile Section -->
        <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-200">
            <h3 class="text-xl font-semibold text-gray-800 mb-4">Your Profile</h3>
            <p class="text-gray-600 mb-4">Update your personal information, change your password, and manage your settings.</p>
            <a href="#" class="text-blue-600 hover:text-blue-500 font-medium transition duration-200">Manage Profile</a>
        </div>
    </div>
    ...
    <div class="mt-8 p-6 bg-blue-50 rounded-lg">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-lg shadow-lg">
                ...
                <a href="#" class="text-blue-600 hover:text-blue-500 font-medium transition duration-200">Browse FAQs</a>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-lg">
                ...
                <a href="#" class="text-blue-600 hover:text-blue-500 font-medium transition duration-200">Visit Help Center</a>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-lg">
