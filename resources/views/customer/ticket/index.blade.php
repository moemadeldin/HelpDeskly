        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($tickets as $ticket)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $ticket->agent->full_name ?? null }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        <a href="{{ route('tickets.edit', $ticket) }}" class="text-green-600 hover:text-green-900">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('tickets.create') }}" class="text-blue-600 hover:text-blue-500 font-medium">
